...
class AddForeignKeysToSiteContatosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        // criando a fk removendo a coluna motivo_contato
        Schema::table('site_contatos', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        // atribuindo motivo_contatos_id de volta para motivo_contato
